...
app_router.include_router(pc_report_controller.router, prefix="/pc/report", tags=["pcReportManager"])
...
app_router.include_router(pc_picture_controller.router, prefix="/pc/picture", tags=["pcPictureManager"])
